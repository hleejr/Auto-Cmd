...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] **_FILL IN THE BLANK_**: `I will use the gtranslate library. The documentation is located at https://github.com/bregydoc/gtranslate. My goal is to use it to translate text from one language to another before generating html.`
- [z] **Add, commit, and push to GitHub**.
